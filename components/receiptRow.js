...
export default function ReceiptRow(props) {
    ...
    // console.log(receipt.issues[0]);
    const firstLetter = receipt.issues[0];
    let issuesColor = "green";
    if(firstLetter == 'n' || firstLetter == 'N' ){
        // console.log("red");
        // console.log(issueLetter);
        issuesColor = "green"
    } else {
        // console.log("green");
        // console.log(issueLetter);
                ...
                <Stack direction="row" spacing={2} sx={{ alignItems: "center" }}>
                    ...
                    <Stack direction="row" className={styles.contentRow}>
                        <Stack direction="column" sx={{ flexGrow: 1 }}>
                            ...
                            <Typography variant="h4" color ={issuesColor}>
                        ...
                        <Stack direction="column" sx={{ flexGrow: 1 }}>
                            ...
                            <Typography variant="h5">
                                Work done: {receipt.work} 
                            </Typography>
                            <Typography variant="h5">
                                Equipment: {receipt.equipment}
                            </Typography>                
                        </Stack>
                    </Stack>
                </Stack>
